...
public interface DataAccessInterface {
	...
	Erabiltzailea isLogin(String erabiltzaileIzena, String pasahitza);

	Erabiltzailea register(String izena, String abizena1, String abizena2, String erabiltzaileIzena, String pasahitza, String telefonoZbkia, String emaila, Date jaiotzeData) throws UserAlreadyExist;

	boolean deleteQuestion(Integer eventNumber, Integer questionNumber, String question);

	boolean deleteEvent(Integer eventNumber);
