...
public class Event implements Serializable {
	...
	@OneToMany(fetch=FetchType.EAGER, targetEntity = Question.class, mappedBy = "event", cascade = {CascadeType.ALL, CascadeType.REMOVE})
	...
	public List<Question> removeQuestions() {
		List<Question> lag = this.questions;
